// used references :  GitHub repository - https://github.com/Jurinho/2d-Histogram-filter-c-/blob/master/localizer%20(1).cpp and
//GitHub repository - https://github.com/bcko/Ud-ISDC-2DHistogramFilter-Cpp/blob/master/localizer.cpp
/**
	localizer.cpp
